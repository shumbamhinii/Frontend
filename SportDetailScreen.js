    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailSection}>
        ...
        <View style={styles.detailTextContainer}>
          ...
          <Text style={styles.detailText}>{item.how_to_join || 'No schedule available'}</Text>
        </View>
      </View>
      <View style={styles.detailSection}>
        ...
        <View style={styles.detailTextContainer}>
          ...
          <Text style={styles.detailText}>{item.meeting_times || 'No location details available'}</Text>
        </View>
      </View>
      <View style={styles.detailSection}>
